        ...
        <div>
          <div className="mb-12">
            ...
            <p className="font-mono text-sm uppercase tracking-widest text-muted-foreground">
              ROOTED IN <span className="text-primary">PURPOSE</span>. DRIVEN BY{" "}
        ...
        >
          <div className="relative w-72 h-72 sm:w-80 sm:h-80 flex items-center justify-center">
            ...
            <div className="text-center z-10">
              ...
              <p className="font-mono text-sm uppercase tracking-[0.2em] text-primary drop-shadow-[0_0_8px_rgba(16,185,129,0.5)]">
                PASSION
              </p>
